...
Start-Process -FilePath rclone -ArgumentList 'sync "C:/Users/faris/" pcloud10tb:/backups/mirror/faris --log-file=C:/Users/faris/rclone_logs/faris_pcloud.txt  --log-level=INFO --filter-from rclone-sync-filter-list.txt -P -l --max-backlog=-1 --transfers=30 --buffer-size=50M --use-mmap --fast-list --drive-chunk-size 64M --retries 3 --timeout 60s --contimeout 60s'
# sync C:/Users/faris to NAS
Start-Process -FilePath rclone -ArgumentList 'sync "C:/Users/faris/" Z:/backups/mirror/faris --log-file=C:/Users/faris/rclone_logs/faris_nas.txt  --log-level=INFO                      --filter-from rclone-sync-filter-list.txt -P -l --max-backlog=-1 --transfers=30 --buffer-size=50M --use-mmap --fast-list --drive-chunk-size 64M --retries 3 --timeout 60s --contimeout 60s'
# sync C:/Users/faris to E: internal drive
Start-Process -FilePath rclone -ArgumentList 'sync "C:/Users/faris/" E:/backups/mirror/faris --log-file=C:/Users/faris/rclone_logs/faris_e.txt  --log-level=INFO                        --filter-from rclone-sync-filter-list.txt -P -l --max-backlog=-1 --transfers=30 --buffer-size=50M --use-mmap --fast-list --drive-chunk-size 64M --retries 3 --timeout 60s --contimeout 60s'

# sync D: to pcloud
Start-Process -FilePath rclone -ArgumentList 'sync "D:/" pcloud10tb:/backups/mirror/d --log-file=C:/Users/faris/rclone_logs/d_pcloud.txt  --log-level=INFO                     --filter-from rclone-sync-filter-list.txt -P -l --max-backlog=-1 --transfers=30 --buffer-size=50M --use-mmap --fast-list --drive-chunk-size 64M --retries 3 --timeout 60s --contimeout 60s'
# sync D: to NAS
Start-Process -FilePath rclone -ArgumentList 'sync "D:/" Z:/backups/mirror/d --log-file=C:/Users/faris/rclone_logs/d_nas.txt  --log-level=INFO                                          --filter-from rclone-sync-filter-list.txt -P -l --max-backlog=-1 --transfers=30 --buffer-size=50M --use-mmap --fast-list --drive-chunk-size 64M --retries 3 --timeout 60s --contimeout 60s'
# sync D: to E: internal drive
Start-Process -FilePath rclone -ArgumentList 'sync "D:/" E:/backups/mirror/d --log-file=C:/Users/faris/rclone_logs/d_e.txt  --log-level=INFO                                            --filter-from rclone-sync-filter-list.txt -P -l --max-backlog=-1 --transfers=30 --buffer-size=50M --use-mmap --fast-list --drive-chunk-size 64M --retries 3 --timeout 60s --contimeout 60s'
